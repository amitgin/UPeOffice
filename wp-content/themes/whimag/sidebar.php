...
<aside class="widget">
<h3 class="widget-title"><span><?php echo strtoupper($dynamic_sidebar); ?> <?php _e('Widget', 'whimag'); ?></span></h3>
<div class="textwidget">
<?php printf( __( 'This is a widget area for %1$s. You need to setup your widget item in <a href="%2$s">here</a>', 'whimag' ), $dynamic_sidebar,admin_url('widgets.php') ); ?>
</div>
</aside>
<?php } ?>
