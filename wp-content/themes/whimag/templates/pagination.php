...
echo paginate_links( array(
    ...
    'prev_text'  => __('&laquo;','whimag'),
    'next_text'  => __('&raquo;','whimag'),
    'before_page_number' => ''
) );
echo '</div>';
?>
...
<div class="alignright"><?php next_posts_link(__('Older Entries &raquo;', 'whimag') ); ?></div>
<div class="alignleft"><?php previous_posts_link(__('&laquo; Newer Entries', 'whimag') ); ?></div>
</div>
<?php endif; ?>
</div>
<?php } ?>
