...
printf( __( '<span class="meta-prep meta-prep-entry-date">Published </span> <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%8$s</a>.', 'whimag' ),
...
<div class="alignleft"><?php previous_image_link( false, __( '&larr; Previous Image', 'whimag' ) ); ?></div>
<div class="alignright"><?php next_image_link( false, __( 'Next Image &rarr;', 'whimag' ) ); ?></div>
</div>
