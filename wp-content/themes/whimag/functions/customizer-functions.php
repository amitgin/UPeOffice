...
<select data-customize-setting-link="<?php echo $this->id; ?>">
<option<?php $catsave = get_theme_mod($this->id); if( $catsave == '' && $catsave == 'Choose a category' ) { ?> selected="selected"<?php } ?> value="Choose a category"><?php _e('Choose a category', 'whimag'); ?></option>
...
'theme_supports'	=> '',
'title' 			=> __( 'Theme Options', 'whimag' ),
'description' 		=> __( 'Customize this theme', 'whimag' ),
)
);
...
'title'			=> __( 'Fonts', 'whimag' ),
'description'	=> __( 'Theme fonts settings', 'whimag' ),
'priority'	=> 30,
...
'title'			=> __( 'Posts', 'whimag' ),
'description'	=> __( 'Theme posts settings', 'whimag' ),
'priority'	=> 35,
'panel'	=> 'frkw_posts_option_panel'
)
);
...
'title'			=> __( 'Slider', 'whimag' ),
'description'	=> __( 'Theme slider settings', 'whimag' ),
'priority'	=> 40,
'panel'	=> 'frkw_posts_option_panel'
)
);
...
'title'			=> __( 'Advertisement', 'whimag' ),
'description'	=> __( 'Advertisement location settings', 'whimag' ),
'priority'	=> 30,
'panel'	=> 'frkw_posts_option_panel'
)
);
...
'title'			=> __( 'Miscellaneous', 'whimag' ),
'description'	=> __( 'Miscellaneous settings', 'whimag' ),
'priority'	=> 40,
'panel'	=> 'frkw_posts_option_panel'
)
);
...
'title'			=> __( 'Custom CSS', 'whimag' ),
'description'	=> __( 'Custom css and style settings', 'whimag' ),
'priority'	=> 50,
'panel'	=> 'frkw_posts_option_panel'
)
);
...
$wp_customize->add_setting('header_color',array('type' => 'theme_mod','capability' => 'edit_theme_options','default' => '','sanitize_callback' => 'frkw_sanitize_css'));

$wp_customize->add_setting('nav_color',array('type' => 'theme_mod','capability' => 'edit_theme_options','default' => '','sanitize_callback' => 'frkw_sanitize_css'));

$wp_customize->add_setting('link_color',array('type' => 'theme_mod','capability' => 'edit_theme_options','default' => '','sanitize_callback' => 'frkw_sanitize_css'));

$wp_customize->add_setting('footer_color',array('type' => 'theme_mod','capability' => 'edit_theme_options','default' => '','sanitize_callback' => 'frkw_sanitize_css'));
...
$wp_customize->add_setting('entry_view_comment_count',array('type' => 'theme_mod','capability' => 'edit_theme_options','default' => 'enable','sanitize_callback' => 'frkw_sanitize_select'));

$wp_customize->add_setting('slider_on',array('type' => 'theme_mod','capability' => 'edit_theme_options','default' => 'disable','sanitize_callback' => 'frkw_sanitize_select'));

$wp_customize->add_setting('slider_feat_cat',array('type' => 'theme_mod','capability' => 'edit_theme_options','default' => '','sanitize_callback' => 'frkw_sanitize_nohtml'));

$wp_customize->add_setting('slider_feat_cat_count',array('type' => 'theme_mod','capability' => 'edit_theme_options','default' => '','sanitize_callback' => 'frkw_sanitize_number_absint'));

$wp_customize->add_setting('slider_feat_post',array('type' => 'theme_mod','capability' => 'edit_theme_options','default' => '','sanitize_callback' => 'frkw_sanitize_nohtml'));
...
$wp_customize->add_setting( 'schema_on', array('type' => 'theme_mod','capability' => 'edit_theme_options','default' => 'disable','sanitize_callback' => 'frkw_sanitize_select') );

$wp_customize->add_setting( 'schema_breadcrumb_on', array('type' => 'theme_mod','capability' => 'edit_theme_options','default' => 'disable','sanitize_callback' => 'frkw_sanitize_select') );
...
$wp_customize,'body_font',array('label' => 'Body Font','section' => 'custom_font_section','description'	=> __( 'Body', 'whimag' ),'settings' => 'body_font')));

$wp_customize->add_control(
new FRKW_Fonts_Weight_Option_Control (
$wp_customize,'body_font_weight',array('label' => 'Body Font Weight','section' => 'custom_font_section','description'	=> __( 'font weight', 'whimag' ),'settings' => 'body_font_weight')));
...
$wp_customize->add_control(
    new FRKW_Fonts_Family_Option_Control (
        ...
        array(
            ...
            'description'	=> __( 'Headline', 'whimag' ),
...
$wp_customize->add_control(
     new FRKW_Fonts_Weight_Option_Control (
        ...
        array(
            ...
            'section' => 'custom_font_section',
            'description'	=> __( 'font weight', 'whimag' ),
...
$wp_customize->add_control(
    new FRKW_Fonts_Family_Option_Control (
        ...
        array(
            ...
            'section' => 'custom_font_section',
            'description'	=> __( 'Navigation', 'whimag' ),
...
$wp_customize->add_control( new WP_Customize_Color_Control(
$wp_customize,'nav_color',
        array(
            'label' => __("Navigation", 'whimag'),
            'section' => 'colors',
            'settings' => 'nav_color',
        )));
...
$wp_customize->add_control( new WP_Customize_Color_Control(
$wp_customize,'footer_color',
        array(
            'label' => __("Footer", 'whimag'),
            'section' => 'colors',
            'settings' => 'footer_color',
        )));

$wp_customize->add_control( 'first_feat_img', array(
'label'   =>  __("Enable First Image Grab for Featured Thumbnails", 'whimag'),
...
'label'   =>  __("Enable Related Posts", 'whimag'),
'section' => 'custom_post_section',
'settings'   => 'related_on',
'type'     => 'radio',
'choices'  => array(
...
$wp_customize->add_control(
     new frkw_Choose_Count_Option_Control (
        ...
        array(
            'label'   => 'Related Count',
            'section' => 'custom_post_section',
            'description'	=> __( 'Choose related count', 'whimag' ),
...
'label'   => __("Enable Author Bio", 'whimag'),
'section' => 'custom_post_section',
...
'label'   => __("Enable Breadcrumbs", 'whimag'),
'section' => 'custom_post_section',
...
'label'   => __("Enable Social Share", 'whimag'),
'section' => 'custom_post_section',
'settings'   => 'social_on',
'type'     => 'radio',
'choices'  => array(
...
$wp_customize->add_control( 'entry_view_comment_count', array(
'label'   => __("Enable Views and Comments Count", 'whimag'),
'section' => 'custom_post_section',
'settings'   => 'entry_view_comment_count',
'type'     => 'radio',
'choices'  => array(
'disable'  => 'Disable',
'enable' => 'Enable',
...
'label'   => __("Enable Featured Slider", 'whimag'),
...
$wp_customize->add_control( 'slider_feat_cat', array(
'label' => __("Categories ID", 'whimag'),
'description' => __("Add a list of category ids if you want to use category as featured. <em>*leave blank to use bottom post ids featured</em><br /><small>example: 3,4,68</small>", 'whimag'),
'section' => 'custom_slider_section',
'settings'   => 'slider_feat_cat',
'type'     => 'text'
)
);
...
$wp_customize->add_control(
     new frkw_Choose_Count_Option_Control (
        $wp_customize,
        'slider_feat_cat_count',
        array(
            'label'   => __("Limit to how many posts", 'whimag'),
            'section' => 'custom_slider_section',
            'description'	=> __("How many posts to show?", 'whimag'),
            'settings' => 'slider_feat_cat_count'
        )
    )
);


$desc_string_slider = sprintf( __("Add a list of post ids to featured in slider. Post type: %s Supported.<br /><small>example: 136,928,925,80,77,55,49</small>", 'whimag'), get_transient('frkw_supported_posttype') );

$wp_customize->add_control( 'slider_feat_post', array(
'label' => __("Posts ID", 'whimag'),
'description' => $desc_string_slider,
'section' => 'custom_slider_section',
'settings'   => 'slider_feat_post',
'type'     => 'text'
)
);
...
'label' => __("Top Header", 'whimag'),
'description' => __("Add script code or image banner here", 'whimag'),
...
'label' => __("First Post Loop", 'whimag'),
'description' => __("Add script code or image banner here.", 'whimag'),
'section' => 'custom_ads_section',
...
'label' => __("Second Post Loop", 'whimag'),
'description' => __("Add script code or image banner here", 'whimag'),
'section' => 'custom_ads_section',
...
'label' => __("Single Post Top", 'whimag'),
'description' => __("Add script code or image banner here", 'whimag'),
'section' => 'custom_ads_section',
...
'label' => __("Single Post Bottom", 'whimag'),
'description' => __("Add script code or image banner here", 'whimag'),
'section' => 'custom_ads_section',
...
'label' => __("Schema.org Markup for Posts", 'whimag'),
'description' => __("Choose to disable or enable schema markup for posts", 'whimag'),
...
'label' => __("Schema.org Markup for Breadcrumb", 'whimag'),
'description' => __("Choose to disable or enable schema markup for site breadcrumb", 'whimag'),
'section' => 'custom_misc_section',
...
'label'   => __( 'Facebook Link', 'whimag' ),
'description' => __( 'Enter full url include http for your Facebook link', 'whimag' ),
'section' => 'custom_misc_section',
...
'label'   => __( 'Twitter Link', 'whimag' ),
'description' => __( 'Enter full url with http for your Twitter link', 'whimag' ),
'section' => 'custom_misc_section',
...
'label'   => __( 'Google Plus Link', 'whimag' ),
'description' => __( 'Enter full url with http for your Google Plus link', 'whimag' ),
'section' => 'custom_misc_section',
...
'label'   => __( 'Pinterest Link', 'whimag' ),
'description' => __( 'Enter full url with http for your Pinterest link', 'whimag' ),
'section' => 'custom_misc_section',
...
'label'   => __( 'RSS Feed Link', 'whimag' ),
'description' => __( 'Enter full url with http for your RSS feed link', 'whimag' ),
'section' => 'custom_misc_section',
