...
if( is_wp_error( $response ) ) {
   echo __('Something went wrong!','whimag');
} else {
...
"Helvetica","Lucida Grande","Courier New","Lucida Console","Impact","Georgia","Palatino Linotype","Material","Icons");
