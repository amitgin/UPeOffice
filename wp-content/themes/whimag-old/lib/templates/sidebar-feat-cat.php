...
<?php echo get_featured_post_image("", "", 180, 150, "alignleft", "thumbnail", 'image-'.get_the_ID() ,get_the_title(), true); ?>

<div class="sidefeat-meta">
<h4><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php echo the_title(); ?></a></h4>
<span class=""><?php echo $icon_comment; ?><?php comments_popup_link(__('No Comment',TEMPLATE_DOMAIN), __('1 Comment',TEMPLATE_DOMAIN), __('% Comments',TEMPLATE_DOMAIN) ); ?></span>
</div>
